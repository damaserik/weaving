              ...
              <div class="row">
                <div class="col-md-12" style="font-size: 13px;">
                  <div class="row">
                      ...
                      <form class="form-inline" method="POST" action="<?php echo site_url('shtl3/laporan/laporan_kain_cetak');?>" target="_blank">
                      ...
                      <!-- view laporan  -->
                      <form class="form-inline" method="POST" action="<?php echo site_url('shtl3/laporan/laporan_kain');?>" target="_blank">
