            ...
            <h4>Eff Permesin</h4>
              ...
              <div class="row">
              	<div class="col-md-12" style="font-size: 13px;">
                      ...
                      <form class="form-inline" method="POST" action="<?php echo site_url('shtl3/laporan/laporan_permesin_cetak');?>" target="_blank">
                      ...
                      <!-- view laporan  -->
                      <form class="form-inline" method="POST" action="<?php echo site_url('shtl3/laporan/laporan_permesin_view');?>" target="_blank">
