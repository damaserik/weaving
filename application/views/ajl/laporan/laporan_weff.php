            ...
            <h4>Weff</h4>
              ...
              <div class="row">
              	<div class="col-md-12" style="font-size: 13px;">
                      ...
                      <form class="form-inline" method="POST" action="<?php echo site_url('ajl/laporan/laporan_weff_cetak');?>" target="_blank">
                      ...
                      <!-- view laporan  -->
                      <form class="form-inline" method="POST" action="<?php echo site_url('ajl/laporan/laporan_weff_view');?>" target="_blank">
