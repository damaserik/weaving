            ...
            <h4>Eff Montir</h4>
              ...
              <div class="row">
              	<div class="col-md-12" style="font-size: 13px;">
                      ...
                      <form class="form-inline" method="POST" action="<?php echo site_url('ajl/laporan/laporan_montir_cetak');?>" target="_blank">
<!--                         <div class="form-group">
                      ...
                      <!-- view laporan  -->
                      <form class="form-inline" method="POST" action="<?php echo site_url('ajl/laporan/laporan_montir_view');?>" target="_blank">
